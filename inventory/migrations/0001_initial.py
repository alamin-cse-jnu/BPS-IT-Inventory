# Generated by Django 4.2.7 on 2025-07-14 06:16
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("purpose", models.CharField(blank=True, max_length=800)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "name",
                    models.CharField(
                        help_text="Block name (e.g., East Block, West Block)",
                        max_length=100,
                    ),
                ),
                (
                    "code",
                    models.CharField(
                        help_text="Block code (e.g., EB, WB, NB, SB)", max_length=20
                    ),
                ),
                (
                    "description",
                    models.TextField(blank=True, help_text="Description of this block"),
                ),
                ("is_active", models.BooleanField(default=True)),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("warranty_provider", models.CharField(blank=True, max_length=300)),
                (
                    "processor",
                    models.CharField(
                        blank=True,
